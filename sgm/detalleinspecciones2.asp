	...
	'strName = strName & ".xls"
				...
				While Not ORs.EOF 
				  ...
				  If Not oRsFiles.EOF Then
					  context = context &  "<td WIDTH='106'><p><a href='../FILES/" & ORsFiles.Fields.Item(0).Value & "'  rel='facebox' >"
					  context = context & "<img src='../FILES/"& ORsFiles.Fields.Item(0).Value 
					  context = context &  "' WIDTH='100' border='1'  ONERROR='this.src='../images/noDisponible.png''/><br /><br />"
					  context = context &  "</a></p></td>"
				  else
					  context = context &  "<td WIDTH='106'><p></p></td>"
				  end if
				  'context = context &  "' WIDTH='100' border='1'  ONERROR='this.src='images/noDisponible.png''/><br /><br />"
				  'context = context &  "</a></p></td>"
...
<table width="705" border="0" align="center">
  <tr>
    <td width="614" align="center"><font class="titulo">COMPONENTES EN RIESGO</font></td>
