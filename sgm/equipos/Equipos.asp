...
function ListTipos()
	 ...
	 query = query & "FROM TIPO_EQUIPOS WHERE ACTIVO='ACT'"
	Set ORs =oDB.EjecutaSql(query)
	Response.Write "<?xml version='1.0' encoding='ISO-8859-1'?>" & VbCrLf & VbCrLf
	Response.Write "<REGISTROS>"
	While Not ORs.EOF 
...
function GetEquipo()
	...
	query = query & " LEFT OUTER JOIN  TTMDATA.EXISTENCIAS.PROVEEDORES AS P ON E.PROVEEDOR = P.RUT"
...
function ListProv()
	query = "SELECT RUT_PROVEEDOR, NOMBRE FROM TTMDATA.EXISTENCIAS.PROVEEDORES"
	Set ORs =oDB.EjecutaSql(query)
	Response.Write "<?xml version='1.0' encoding='ISO-8859-15'?>" & VbCrLf & VbCrLf
	Response.Write "<REGISTROS>"
	While Not ORs.EOF 
