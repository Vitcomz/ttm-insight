...
'	query = query & " E.CODIGO=" & strNvl(CODIGO) & " AND "
	query = query & " E.UBICACION in (" & strNvl(xFaena) & ") and (e.codigo not like '%PCAR-P%' and e.codigo not like '%PCAR-E%' "
	query = query & " and e.codigo not like '%EST%' and e.codigo not like '%PRET-P%' and e.codigo not like '%PRET-E%' and e.codigo not like '%ZDI-P%' and e.codigo not like '%ZDI-E%')) "
	query = query & " AS E "
	'query = query & " LEFT OUTER JOIN  EXISTENCIAS.DBO.PROVEEDORES AS P ON E.PROVEEDOR = P.RUT"
	query = query & " LEFT OUTER JOIN TIPO_EQUIPOS AS TE ON E.TIPO_EQUIPO = TE.CODIGO  order by E.UBICACION ;"
...
function GetEquipoESTACION()
	...
	query = query & "  WHERE "
'	query = query & " E.CODIGO=" & strNvl(CODIGO) & " AND "
	query = query & " E.UBICACION in (" & strNvl(xFaena) & ") and (e.codigo like '%EST%' or e.codigo like '%PRET-E%' or e.codigo like '%PCAR-E%' or e.codigo like '%ZDI-E%')) "
	query = query & " AS E "
	'query = query & " LEFT OUTER JOIN  EXISTENCIAS.DBO.PROVEEDORES AS P ON E.PROVEEDOR = P.RUT"
	query = query & " LEFT OUTER JOIN TIPO_EQUIPOS AS TE ON E.TIPO_EQUIPO = TE.CODIGO  order by E.UBICACION ;"
...
function GetEquipoPCAR()
	...
	query = query & "  WHERE "
'	query = query & " E.CODIGO=" & strNvl(CODIGO) & " AND "
	query = query & " E.UBICACION in (" & strNvl(xFaena) & ") and (e.codigo like '%PCAR-P%')) "
	query = query & " AS E "
	'query = query & " LEFT OUTER JOIN  EXISTENCIAS.DBO.PROVEEDORES AS P ON E.PROVEEDOR = P.RUT"
	query = query & " LEFT OUTER JOIN TIPO_EQUIPOS AS TE ON E.TIPO_EQUIPO = TE.CODIGO  order by E.UBICACION ;"
...
function GetEquipoPRET()
	...
	query = query & "  WHERE "
'	query = query & " E.CODIGO=" & strNvl(CODIGO) & " AND "
	query = query & " E.UBICACION in (" & strNvl(xFaena) & ") and (e.codigo like '%PRET-P%')) "
	query = query & " AS E "
	'query = query & " LEFT OUTER JOIN  EXISTENCIAS.DBO.PROVEEDORES AS P ON E.PROVEEDOR = P.RUT"
	query = query & " LEFT OUTER JOIN TIPO_EQUIPOS AS TE ON E.TIPO_EQUIPO = TE.CODIGO  order by E.UBICACION ;"
...
function GetEquipoZDI()
	...
	query = query & "  WHERE "
'	query = query & " E.CODIGO=" & strNvl(CODIGO) & " AND "
	query = query & " E.UBICACION in (" & strNvl(xFaena) & ") and (e.codigo like '%ZDI-P%')) "
	query = query & " AS E "
	'query = query & " LEFT OUTER JOIN  EXISTENCIAS.DBO.PROVEEDORES AS P ON E.PROVEEDOR = P.RUT"
	query = query & " LEFT OUTER JOIN TIPO_EQUIPOS AS TE ON E.TIPO_EQUIPO = TE.CODIGO  order by E.UBICACION ;"
