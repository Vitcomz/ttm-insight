...
<script runat="server">
    ...
    Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs)
        ...
        Else
			...
			'IF FSR IS NOTHING AND  FSR.length = 0 Then
			IF  len(FSR)> 0 Then
			FSR="0"
			END IF
            ...
            Else
                ...
                If maxSize > 0 Then			
					...
					'   thumbNailImg = fullSizeImg.GetThumbnailImage(newWidth, newHeight, dummyCallBack, IntPtr.Zero)
                     '  thumbNailImg.Save(Server.MapPath(imageUrl & "p"), Drawing.Imaging.ImageFormat.Jpeg)
           ...
           End If
				...
				Dim thFileName = mid(imageUrl, 8, len(imageUrl))
				
				'response.write thDir
				
				thumbNailImg.Save(Server.MapPath("/files/pr_" & thFileName  ), Drawing.Imaging.ImageFormat.Jpeg)
                'Clean up / Dispose...
