...
<div id="content">
<table WIDTH="900px"  BORDER="0" cellpadding="5" cellspacing="5" BORDERCOLOR="#000000"
      ...
      <xsl:for-each select="*/ROW"> 
			<tr >
				<td HEIGHT="26" valign="top"  width="120px">
                 <!--<b>CORR.<xsl:value-of select="N"/></b><br />-->
                    ...
                    <xsl:otherwise>
            				  <td valign="top" width="150px">
								<b><xsl:value-of select="EQUIPO"/></b><br />
                                  ...
                                  ID:&#160;<xsl:value-of select="ID"/>&#160;<xsl:value-of select="FECHA"/>&#160;
                          		  DÍAS ATRASO:&#160;<xsl:value-of select="DIAS"/> <br />
                                 <b>CRITICIDAD:&#160;<xsl:value-of select="COLOR"/></b><br />
				...
				<td COLSPAN="2" VALIGN="TOP" class="justif">
                	<xsl:value-of select="DESCRIPCION"/><br /> <br />
                    <span class="tinyText"><b>HISTORIAL</b></span><br />
                    <xsl:for-each select="HISTORIAL" >
                	          <span class="tinyText">
                              <b>ESTADO:&#160;<xsl:value-of select="STATUS"/></b><br />
                                 FECHA :&#160;<xsl:value-of select="FECHA"/>&#160;INSPECTOR:&#160;<xsl:value-of select="INSPECTOR"/><br />
