...
'	exit function
	...
	Response.CharSet = "UTF-8"
		...
		While Not ORs.EOF
			  ...
			  Response.Write "<TD>" & ORs.Fields.Item(29).Value & "</TD>"
			  Response.Write "<TD>" & ORs.Fields.Item(30).Value & "</TD>"
			  Response.Write "<TD>" & ORs.Fields.Item(31).Value & "</TD>"
			  Response.Write "</TR>"
