...
JSSurfacePlot = function(x, y, width, height, colourGradient, targetElement, fillRegions, tooltips, xTitle, yTitle, zTitle, renderPoints, backColour,
   axisTextColour, hideFlatMinPolygons, tooltipColour, origin, startXAngle_canvas, startZAngle_canvas, rotationMatrix, zAxisTextPosition, glOptions, data){
    ...
    this.render = function(){
        ...
        else // Render not quite so shiny non-GL surface-plot.
        {
           ...
           // canvasContext.fillRect(0, 0, canvas.width, canvas.height);
            ...
            //cameraPosition = new Point3D(drawingDim / 2.0 + marginX, drawingDim / 2.0 + marginY, drawingDim / 2.0 + marginY, -1000.0);
	...
	//LAYER LEYENDA
	this._redrawLegend = function() {
//	        targetDiv2 = document.createElement("div");
//	        targetDiv2.id = "surface_leg";
//    	    //targetDiv2.className = "surfaceplot";
//        	targetDiv2.style.background = '#FFFFFF';
//       		targetDiv2.style.position = 'absolute';
//			targetDiv2.style.left = "38px";
//			targetDiv2.style.top =  "92px";
//			targetDiv2.style.zIndex = 1;
//			if (!targetElement) 
//				return;
//				//document.body.appendChild(this.targetDiv2);
//			else {
//				//targetDiv2.style.position = 'relative';
//				targetElement.appendChild(targetDiv2);
//			}
//			
//		canvas2 = document.createElement("canvas");
//        //this.initCanvas();
//        canvas2.className = "surfacePlotCanvas";
//		canvas2.id = "surfacePlotCanvas1";
//        canvas2.setAttribute("width", 100);
//        canvas2.setAttribute("height", 180);
//        canvas2.style.left = '0px';
//        canvas2.style.top = '0px';
//        targetDiv2.appendChild(canvas2);
//		
////        canvasContext1 = canvas.getContext("2d");
////        canvasContext1.font = "bold 18px sans-serif";
////        canvasContext1.clearRect(0, 0, canvas.width, canvas.height);
////        canvasContext1.fillStyle = '#FFFFFF';
////        canvasContext1.fillRect(0, 0, canvas.width, canvas.height);    
////        canvasContext1.beginPath();
////        canvasContext1.rect(0, 0, 50, 100);
////        canvasContext1.strokeStyle = '#000';
////        canvasContext1.stroke();    
//				
//		
//		var dotSize = 400 * 0.02;
//	
//		var widthMin = dotSize / 2; // px
//		var widthMax = dotSize / 2 + dotSize * 2; // Todo: put this in one function
//
//		var height = Math.max(50 * 0.25, 120);
//		var top = 20;
//		var right = 400 - 320;
...
//		ctx1.lineWidth = 1;
//		ctx1.font = "14px arial"; // TODO: put in options
////	
...
//				ctx1.beginPath();
//				ctx1.moveTo(left, top + y);
//				ctx1.lineTo(right, top + y);
//				ctx1.stroke();
//			}
//	
//			ctx1.strokeStyle =  this.colorAxis;
//			ctx1.strokeRect(left, top, widthMax, height);
//////		}
////	
////	
//			// print values along the color bar
//			var gridLineLen = 5; // px
//			var step = new links.StepNumber(this.minZValue, this.maxZValue, (this.maxZValue-this.minZValue)/5, true);
//			step.start();
//			if (step.getCurrent() < this.minZValue) {
//				step.next();
//			}
//			while (!step.end()) {
//				var y = bottom - (step.getCurrent() - this.minZValue) / (this.maxZValue - this.minZValue) * height;
//	
//				ctx1.beginPath();
//				ctx1.moveTo(left - gridLineLen, y);
//				ctx1.lineTo(left, y);
//				ctx1.stroke();
//	
//				ctx1.textAlign = "right";
//				ctx1.textBaseline = "middle";
//				ctx1.fillStyle = this.colorAxis;
//				ctx1.fillText(step.getCurrent(), left - 2 * gridLineLen, y);
//	
//				step.next();
//			}
////	
...
//			ctx1.fillText("Amplitud", right + 10, bottom + 10);
//	        canvas2.owner = this;
//			
//
	};
    ...
    this.createPolygons = function(data3D){
        ...
        for (i = 0; i < this.numXPoints - 1; i++) {
            for (j = 0; j < this.numYPoints - 1; j++) {
                ...
                (rawP2.lz == this.minZValue || (rawP1.lz == this.minZValue && rawP4.lz == this.minZValue) || ((rawP4.lz == this.minZValue || rawP3.lz == this.minZValue) && i > 1 && j > 0))) 
                    continue;
    ...
    this.redraw = function(){
        ...
        if (this.frames) {
            for (var k = 0; k < this.numFrames; k++) {
                ...
                dataframe = new Array();
                for (i = 0, xPos = -0.5; i < this.numXPoints; i++, xPos += xDivision) {
                    for (j = 0, yPos = 0.8; j < this.numYPoints; j++, yPos -= yDivision) {
                        var x = xPos;
                        var y = yPos;
    ...
    this.drawScene = function(){
        ...
        mat4.perspective(4.1, this.gl.viewportWidth / this.gl.viewportHeight, 0.1, 100.0, this.pMatrix);
...
GLText = function(data3D, text, pos, angle, surfacePlot, axis, align){
    ...
    this.setUpTextArea = function(){
        this.context2D.font = 'normal 20px Verdana';
...
GLAxes = function(data3D, surfacePlot){
    ...
    this.initAxesBuffers = function(){
        ...
        for (var count = 0; count <= this.surfacePlot.glOptions.xTicksNum; i += lineIntervalX, count++) {
            ...
            labelPos = {
                x: yAxisEndPoint[0] + i,
                y: yAxisEndPoint[1] - 0.68,
                z: yAxisEndPoint[2] 
            };
            glText = new GLText(data3D, label, labelPos, 75, surfacePlot, "x");
        ...
        //this.axesMinorVertexPositionBuffer.numItems = minorVertices.length / 1;
    };
...
JSSurfacePlot.DEFAULT_X_ANGLE_CANVAS = 0;
JSSurfacePlot.DEFAULT_Z_ANGLE_CANVAS = 0;
JSSurfacePlot.DEFAULT_X_ANGLE_WEBGL = 0;
JSSurfacePlot.DEFAULT_Y_ANGLE_WEBGL = 0;
JSSurfacePlot.DATA_DOT_SIZE = 3;
JSSurfacePlot.DEFAULT_SCALE = 700;
