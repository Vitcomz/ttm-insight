...
links.Graph3d = function (container) {
    ...
    this.verticalRatio = 0.1; // 0.1 to 1.0, where 1.0 results in a "cube"
...
links.Graph3d.prototype._determineColumnIndexes = function(data, style) {
    if (this.style === links.Graph3d.STYLE.DOT || this.style === links.Graph3d.STYLE.DOTLINE || this.style === links.Graph3d.STYLE.LINE || this.style === links.Graph3d.STYLE.GRID || this.style === links.Graph3d.STYLE.SURFACE) {
    ...
    else if (this.style === links.Graph3d.STYLE.DOTCOLOR|| this.style === links.Graph3d.STYLE.DOTSIZE) {
...
links.Graph3d.prototype._getDataPoints = function (data) {
    ...
    if (this.style === links.Graph3d.STYLE.GRID || this.style === links.Graph3d.STYLE.SURFACE) {
...
links.Graph3d.prototype._redrawLegend = function() {
    if (this.style === links.Graph3d.STYLE.DOTCOLOR || this.style === links.Graph3d.STYLE.DOTSIZE) {
