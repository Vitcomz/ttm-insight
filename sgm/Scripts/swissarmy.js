...
document.write(brs+'<div align="center"><font size="2" face="Arial, Helvetica, sans-serif">'+this.dp+'<span id="imgdsc'+this.issid+'">&nbsp;<\/span>&nbsp;&nbsp;ID: <span id="file"><\/span><\/font><input type="hidden" name="idpic" id="idpic" value="1"\/></div>\n');
...
document.write('<div align="center"><font size="2" face="Arial, Helvetica, sans-serif">Fotografia N°: <b><span id="thecnt'+this.issid+'"><\/span><\/b> de<span>&nbsp;</span>&nbsp;<b>'+this.imgs.length+'<\/b><\/font><\/div>');
}
