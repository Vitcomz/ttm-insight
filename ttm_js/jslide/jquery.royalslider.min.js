...
function(c,d,b){b>=a.numSlides?a._l5.append('<div class="rsNavItem rsTab">'+d.thumbnail+"</div>"):a._m5.eq(b).before('<div class="rsNavItem rsTab">'+item.thumbnail+"</div>");a._m5=a._l5.children()}),a.ev.on("rsOnRemoveSlide",function(c,d){var b=a._m5.eq(d);b&&(b.remove(),a._m5=a._l5.children())}),a.ev.on("rsOnUpdateNav",function(){var c=a.currSlideId;a._o5&&a._o5.removeClass("rsNavSelected");c=a._m5.eq(c);c.addClass("rsNavSelected");a._o5=c}))},_h6:function(){var a=this,c;a._k5=!0;c='<div id="botton_panel" class="rsNav rsTabs">';
