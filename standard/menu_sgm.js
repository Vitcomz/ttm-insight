...
var script = "<div style='Z-INDEX: 10000;POSITION: absolute; TOP: 0px;LEFT: 2px;text-align:left;'>"
	...
	script = script + "<TD align='left' class=txtTitle>SISTEMA: S.G.M.</TD><TD align='right' class=txt>" + FechaActual() + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD></TR>";
	script = script + "<TR><TD class=txtTitle>USUARIO : " + Nombres + "</TD>"
...
*************************************/
var url;
url = "xml/Menu.asp?RECURSO=ListMenu&SISTEMA=SGM";
