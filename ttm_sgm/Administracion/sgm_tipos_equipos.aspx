<%@ Page Title="" Language="C#" MasterPageFile="~/ttm_skins/1nivel/ttm_template_1nivel.Master" AutoEventWireup="true" CodeBehind="sgm_tipos_equipos.aspx.cs" Inherits="Insight.ttm_sgm.Administracion.sgm_tipos_equipos" 
                                                	...
                                                	<tr>
                                                    	<td style="width:900; height: 10px;" valign="top">
                                                        	<div class="ContTopLiBx">
                                                                            <div class="ContTitLiBx">Administrador Tipos Equipos</div>
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width:700px">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="height: 24px" align="center" valign="top">Codigo
                                                                                            <br />
                                                                                            Tipo Equipo</td>
                                                                                        <td align="left" valign="top"><asp:TextBox ID="Txtidtipo_equipofiltro" runat="server" SkinID="TextBoxBuscar"></asp:TextBox></td>
                                                                                        <td align="center" valign="top">Nombre
                                                                                            <br />
                                                                                            Tipo Equipo</td>
                                                                                        <td align="left" valign="top"><asp:TextBox ID="Txttipo_equipofiltro" runat="server" SkinID="TextBoxBuscar"></asp:TextBox></td>
                                                                                        <td align="center" valign="top">Estado
                                                                                            <br />
                                                                                            Tipo Equipo</td>
                                                                                        <td align="left" valign="top">
                                                                                            <asp:DropDownList ID="CblEstadotipo_equipofiltro" runat="server" skinID="listamediano">
                                                    	        	        ...
                                                    	        	        <table cellpadding="0" cellspacing="0" border="0" style="width:900px">
                                                    	        	            <tr>    
                                                    	        	                <td style="width:300px; height: 20px;" valign="top" align="left">
                                                    	        	                    <asp:ImageButton runat="server" ID="IBtnNuevoRegistro" SkinID="IBtnNuevoGrid" OnClick="IBtnNuevoRegistro_Click" />&nbsp;&nbsp;<asp:LinkButton runat="server" ID="LBtnNuevoRegistro" Text="AGREGAR NUEVO TIPO EQUIPO" SkinID="LBtnNuevoRegistro" OnClick="LBtnNuevoRegistro_Click" CausesValidation="False"></asp:LinkButton>
                                                    	        	                </td>
                                                                            ...
                                                                            <telerik:radgrid id="RadGrid1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="1" CellSpacing="1" GridLines="None" OnItemCommand="RadGrid1_ItemCommand" OnSortCommand="RadGrid1_SortCommand" OnPageIndexChanged="RadGrid1_PageIndexChanged" OnPageSizeChanged="RadGrid1_PageSizeChanged" OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged">
                                                                                ...
                                                                                <MasterTableView CellPadding="1" CellSpacing="1" DataKeyNames="CODIGO" 
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <telerik:GridBoundColumn DataField="descripcion" HeaderText="Tipo Equipo" 
                                                                                            UniqueName="column3">
                                                                                            <HeaderStyle HorizontalAlign="Center" Width="35%" />
                                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                                        </telerik:GridBoundColumn>
                                                                                        <telerik:GridBoundColumn DataField="EQUIPOCRITICIDAD" HeaderText="Criticidad Equipo" 
                                                                                            UniqueName="column4">
                                                                                            <HeaderStyle HorizontalAlign="Center" Width="35%" />
                                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                                        </telerik:GridBoundColumn>
                                                                                        <telerik:GridBoundColumn DataField="criticidad"  HeaderText="Criticidad"
                                                                                            UniqueName="column5">
                                                                                            <HeaderStyle HorizontalAlign="Center" Width="20%" />
                                                                                            <ItemStyle HorizontalAlign="Center" />
                                                                                        </telerik:GridBoundColumn>
                                                        	            ...
                                                        	            <table cellpadding="0" cellspacing="0" border="0" width="900" class="FormularioMantenedores">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td valign="top" align="left" class="obligatorio" 
                                                                                    style="height: 24px; width: 115px;">Codigo Tipo Equipo</td>
                                                                                <td style="height: 24px">
                                                                                    </td>
                                                                                <td valign="top" align="left" style="height: 24px; width: 154px;">
                                                                                    <asp:TextBox ID="Txtcodigotipo_equipo" runat="server" SkinID="TextBoxCorto"></asp:TextBox>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Txtcodigotipo_equipo"
                                                                                        ErrorMessage="Codigo." Display="Dynamic">*</asp:RequiredFieldValidator>
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="Txtcodigotipo_equipo"
                                                                                        Display="Dynamic" ErrorMessage="Formato no valido solo caracteres en nombre tipo_equipo"
                                                                                ...
                                                                                <td align="left" style="height: 24px; width: 115px;" valign="top" class="obligatorio" >
                                                                                    Nombre Tipo Equipo</td>
                                                                                <td style="height: 24px"></td>
                                                                                <td align="left" style="height: 24px; width: 354px;" valign="top">
                                                                                    <asp:TextBox ID="Txtnombretipo_equipo" runat="server" SkinID="TextBoxlargo"></asp:TextBox>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Txtnombretipo_equipo"
                                                                                        ErrorMessage="Nombre." Display="Dynamic">*</asp:RequiredFieldValidator>
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="Txtnombretipo_equipo"
                                                                                        Display="Dynamic" ErrorMessage="Formato no valido solo caracteres en nombre tipo_equipo"
                                                                                        ValidationExpression=".*[0-9a-zA-Z-_@Á-Úá-ú-_@]+">*</asp:RegularExpressionValidator>
                                                                                </td>
                                                                                <td style="height: 24px">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td align="left" class="obligatorio" style="height: 24px; width: 115px;" 
                                                                                    valign="top">
                                                                                    Criticidad Tipo Equipo</td>
                                                                                <td style="height: 24px">
                                                                                    &nbsp;</td>
                                                                                <td align="left" style="height: 24px; width: 154px;" valign="top">
                                                                                    <asp:TextBox ID="Txtcriticidad_equipo" runat="server" SkinID="TextBoxCorto"></asp:TextBox>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                                                                                        ControlToValidate="Txtnombretipo_equipo" Display="Dynamic" 
                                                                                        ErrorMessage="Nombre.">*</asp:RequiredFieldValidator>
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" 
                                                                                        ControlToValidate="Txtnombretipo_equipo" Display="Dynamic" 
                                                                                        ErrorMessage="Formato no valido solo caracteres en nombre tipo_equipo" 
                                                                                        ValidationExpression=".*[0-9a-zA-Z-_@Á-Úá-ú-_@]+">*</asp:RegularExpressionValidator>
                                                                                </td>
                                                                                <td style="height: 24px">
                                                                                    &nbsp;</td>
                                                                                <td align="left" class="obligatorio" style="height: 24px; width: 115px;" 
                                                                                    valign="top">
                                                                                    Equipo Criticidad</td>
                                                                                <td style="height: 24px">
                                                                                    &nbsp;</td>
                                                                                <td align="left" style="height: 24px; width: 354px;" valign="top">
                                                                                    <asp:TextBox ID="txteqcrtiticidad" runat="server" SkinID="TextBoxlargo"></asp:TextBox>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txteqcrtiticidad"
                                                                                        ErrorMessage="Nombre." Display="Dynamic">*</asp:RequiredFieldValidator>
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="txteqcrtiticidad"
                                                                                        Display="Dynamic" ErrorMessage="Formato no valido solo caracteres en equipo criticidad"
                                                                                        ValidationExpression=".*[0-9a-zA-Z-_@Á-Úá-ú-_@]+">*</asp:RegularExpressionValidator>
                                                                                    &nbsp;</td>
                                                                                <td style="height: 24px">
                                                                                    &nbsp;</td>
