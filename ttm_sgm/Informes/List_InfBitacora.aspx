<%@ Page Title="" Language="C#" MasterPageFile="~/ttm_skins/1nivel/ttm_template_1nivel.Master" AutoEventWireup="true" CodeBehind="List_InfBitacora.aspx.cs" Inherits="Insight.ttm_sgm.Informes.List_InfBitacora"  StyleSheetTheme="ttm" Theme="ttm"  %>
...
<script type="text/javascript">
    function FromHTMLtoPDF() {
        ...
        var eqT = document.getElementById("ctl00_ContentPlaceHolder1_HddequipoText").value;
        ...
        var oManager = window.radopen("ReporteListBitacorasGenPdf.aspx?sec=" + sec + "&eq=" + eq + "&secT=" + secT + "&eqT=" + eqT + "&t1=" + time1 + "&t2=" + time2, null);
                                                	...
                                                	<tr>
                                                    	<td style="width:900; height: 10px;" valign="top">
                                                        	 <div class="ContTopLiBx">
                                                                            <div class="ContTitLiBx">Informe Listado Bitacoras</div>
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width:700px">
                                                                                    ...
                                                                                    <tr>
                                                                                            ...
                                                                                            <td align="left" valign="top" style="height: 17px">
                                                                                                <telerik:RadComboBox ID="CmbSecBitacorafiltro" 
                                                                                            ...
                                                                                            <td align="left" style="height: 17px">
                                                                                                <telerik:RadComboBox ID="CmbEqBitacorafiltro" runat="server" 
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" border="0" width="180">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="height:50px" align="right" valign="top">
                                                                                            ...
                                                                                            <asp:HiddenField ID="HddequipoText" runat="server" />
