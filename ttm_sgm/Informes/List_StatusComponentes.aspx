<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List_StatusComponentes.aspx.cs" Inherits="Insight.ttm_sgm.Informes.List_StatusComponentes" %>
...
<body>
    ...
    <div style="width:880px; display:inline-block; ">
        <div class="ContTopLiBx">
	        <div class="ContTitLiBx">Informes Estado Componentes</div>
            <div class="LogoTTMLiBx"></div>
	        <div class="limpiar"></div>
        </div>
        <div style="padding:0px 5px 15px 5px; " id="dataCompRiesgos" runat="server">
