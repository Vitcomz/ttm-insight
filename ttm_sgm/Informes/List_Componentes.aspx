<%@ Page Title="" Language="C#" MasterPageFile="~/ttm_skins/1nivel/ttm_template_1nivel.Master" AutoEventWireup="true" CodeBehind="List_Componentes.aspx.cs" Inherits="Insight.ttm_sgm.Informes.List_Componentes"  StyleSheetTheme="ttm" Theme="ttm"  EnableEventValidation = "false"  %>
...
////      $('#tabEquipos').tableExport({ type: 'pdf', escape: 'false' });
    ...
    function FromHTMLtoPDF() {
        var eq = document.getElementById("ctl00_ContentPlaceHolder1_CmbTipoEquipofiltro").value;
        var time;
        var alltime = time * 1500;
        var oManager = window.radopen("ReporteListComponentesGenPdf.aspx?eq=" + eq , null);
                                                	...
                                                	<tr>
                                                    	<td style="width:900; height: 10px;" valign="top">
                                                        	 <div class="ContTopLiBx">
                                                                            <div class="ContTitLiBx">Informe Componentes</div>
                                                                        ...
                                                                        <tr id="Tr3" runat="server">
                                                                            <td id="Td3" valign="top" runat="server">
                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width:700px">
                                                                                    ...
                                                                                    <tr>
                                                                                            <td style="width: 11px"></td>
                                                                                            <td valign="top" align="center"><strong>Tipo de Equipo</strong></td>
                                                                                            <td align="left" valign="top"><telerik:RadComboBox ID="CmbTipoEquipofiltro" 
                                                                                                    ...
                                                                                                    onselectedindexchanged="CmbTipoEquipofiltro_SelectedIndexChanged" 
                                                                                    ...
                                                                                    <tr>
                                                                                        <td style="height:50px" align="right" valign="top">
                                                                                            ...
                                                                                            <asp:ImageButton ID="IbtnPdf" runat="server" SkinID="IBtnPdf" 
                                                                                                onclientclick="FromHTMLtoPDF();"   CausesValidation="False" Visible="False" />
