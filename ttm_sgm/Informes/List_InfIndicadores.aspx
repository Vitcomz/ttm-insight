<%@ Page Title="" Language="C#" MasterPageFile="~/ttm_skins/1nivel/ttm_template_1nivel.Master" AutoEventWireup="true" CodeBehind="List_InfIndicadores.aspx.cs" Inherits="Insight.ttm_sgm.Informes.List_InfIndicadores"  StyleSheetTheme="ttm" Theme="ttm"  %>
...
//        //      $('#tabEquipos').tableExport({ type: 'pdf', escape: 'false' });
    ...
    function FromHTMLtoPDF() {
        ...
        var oManager = window.radopen("ReporteListIndicadoresGenPdf.aspx?sec=" + sec + "&f1=" + f1 + "&f2=" + f2, null);
    ...
    function FromHTMLtoEXCEL() {
        $('#TblIndicadores').tableExport({ type: 'excel', escape: 'false' });
    }
                                                	...
                                                	<tr>
                                                    	<td style="width:900; height: 10px;" valign="top">
                                                        	<div class="ContTopLiBx">
                                                                            <div class="ContTitLiBx">Informe Indicadores</div>
                                                                            ...
                                                                            <td id="Td3" valign="top" runat="server">
                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width:700px">
                                                                                    ...
                                                                                    <tr>
                                                                                            ...
                                                                                            <td align="left" valign="top">
                                                                                                <telerik:RadDatePicker ID="rddate1" runat="server" Culture="es-ES">
                                                                                                    <Calendar EnableWeekends="True" FirstDayOfWeek="Monday" 
                                                                                            ...
                                                                                            <td align="left" valign="top">
                                                                                                <telerik:RadDatePicker ID="rddate2" runat="server" Culture="es-ES">
                                                                                                    <Calendar EnableWeekends="True" FirstDayOfWeek="Monday" 
                                                                                                        UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False">
                                                                                                    </Calendar>
                                                                                                    <DateInput DateFormat="dd/MM/yyyy" DisplayDateFormat="dd/MM/yyyy" 
