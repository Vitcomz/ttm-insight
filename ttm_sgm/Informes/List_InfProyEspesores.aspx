<%@ Page Title="" Language="C#" MasterPageFile="~/ttm_skins/1nivel/ttm_template_1nivel.Master" AutoEventWireup="true" CodeBehind="List_InfProyEspesores.aspx.cs" Inherits="Insight.ttm_sgm.Informes.List_InfProyEspesores"  StyleSheetTheme="ttm" Theme="ttm"  %>
...
//        var oManager = window.radopen("ReporteListProyEspesoresGenPdf.aspx?sec=" + sec + "&secT=" + secT, null);
...
//        setTimeout(function () { oManager.close(); }, alltime);
        ...
        var oWnd = radopen("ReporteListProyEspesoresGenPdf.aspx?sec=" + sec + "&secT=" + secT, "rwShowMember");
    ...
    function FromHTMLtoEXCEL() {
        $('#TblProyEspesores').tableExport({ type: 'excel', escape: 'false' });
    }
                                                	...
                                                	<tr>
                                                    	<td style="width:900; height: 10px;" valign="top">
                                                        	<div class="ContTopLiBx">
                                                                            <div class="ContTitLiBx">Informe </div>
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width:700px">
                                                                                    ...
                                                                                    <tr>
                                                                                            ...
                                                                                            <td align="left" valign="top">
                                                                                                ...
                                                                                                <telerik:RadComboBox ID="CmbseccionFiltro" runat="server" CausesValidation="False" 
                                                                                                    DataTextField="description" DataValueField="value"
                                                                                                    Skin="Default" Sort="Ascending" Width="180px" AutoPostBack="True">
                                                                                                </telerik:RadComboBox>
                                                                                            </td>
                                                                                            <td align="center" style="height: 24px" valign="top"><strong>Tipo de Equipo</strong></td>
                                                                                            <td align="left" valign="top" colspan="2">
                                                                                                <telerik:RadComboBox ID="CmbTipoEquipofiltro" runat="server" 
                                                                                                    CausesValidation="False" Sort="Ascending" 
                                                                                                    Width="190px">
                                                                                                </telerik:RadComboBox>
                                                    	    ...
                                                    	    <asp:Panel ID="PnlBuscar" runat="server" Width="900px" 
                                                    	    	...
                                                    	    	<table id="TblBuscar" runat="server" cellpadding="0" cellspacing="0" border="0" 
                                                    	    	    ...
                                                    	    	    <tr id="Tr5" runat="server">
                                                    	    	        <td id="Td6" valign="top" style="width:900px;" runat="server">
                                                                            <asp:Panel ID="PnlZona" runat="server" ScrollBars="Auto" Height="680px" Width="900px"></asp:Panel>
                                                                        </td>
                                                                    </tr>
