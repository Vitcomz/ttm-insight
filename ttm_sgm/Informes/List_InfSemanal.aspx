<%@ Page Language="C#" MasterPageFile="~/ttm_skins/1nivel/ttm_template_1nivel.Master" AutoEventWireup="true" CodeBehind="List_InfSemanal.aspx.cs" Inherits="Insight.ttm_sgm.Informes.List_InfSemanal" StyleSheetTheme="ttm" Theme="ttm"%>
...
<script type="text/javascript">
    function FromHTMLtoPDF() {
        ...
        var oManager = window.radopen("ReporteInspSemGenPdf.aspx?sec=" + sec + "&eq=" + eq + "&tip=" + tip + "&crit=" + crit + "&fech1=" + f1 + "&fech2=" + f2, null);
...
<table cellpadding="0" cellspacing="0" border="0" width="939">
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width:700px">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" valign="top">
                                                                                                ...
                                                                                                <telerik:RadComboBox ID="CmbseccionInfSemanal" runat="server" 
                                                                                                    ...
                                                                                                    onselectedindexchanged="CmbseccionInfSemanal_SelectedIndexChanged" 
                                                                                                    onclientitemchecking="clientItemChecking" 
                                                                                                    ondatabound="CmbseccionInfSemanal_DataBound" 
                                                                                        ...
                                                                                        <td align="left" valign="top">
                                                                                        <telerik:RadComboBox ID="CmbEqInfSemanal" runat="server" DataTextField="description" 
                                                                                                    DataValueField="value" CheckBoxes="true" EnableCheckAllItemsCheckBox="true"
                                                                                                    Skin="Default" Sort="Ascending" Width="180px" 
                                                                                                    Height="350px" 
                                                                                                onselectedindexchanged="CmbEqInfSemanal_SelectedIndexChanged" 
                                                                                                EmptyMessage="[-- Seleccione --]">
                                                                                                    <Localization AllItemsCheckedString="Todos seleccionados" 
                                                                                                        CheckAllString="Seleccionar todos" ItemsCheckedString="seleccionado(s)" 
                                                                                                        NoMatches="No hay seleccion" 
                                                                                        ...
                                                                                        <td align="center" valign="top">Tipo Equipo
                                                                                            <br />
                                                                                            </td>
                                                                                        <td align="left" valign="top">
                                                                                        <telerik:RadComboBox ID="CmbTipoEquipoInfSemanal" runat="server" DataTextField="description" 
                                                                                                DataValueField="value" CheckBoxes="true" EnableCheckAllItemsCheckBox="true"
                                                                                                Skin="Default" Sort="Ascending" Width="180px" 
                                                                                                Height="350px" 
                                                                                                onselectedindexchanged="CmbTipoEquipoInfSemanal_SelectedIndexChanged" 
                                                                                                EmptyMessage="[-- Seleccione --]">
                                                                                                <Localization AllItemsCheckedString="Todos seleccionados" 
                                                                                                        CheckAllString="Seleccionar todos" ItemsCheckedString="seleccionado(s)" 
                                                                                                        NoMatches="No hay seleccion" 
            ...
            <telerik:RadDatePicker ID="rddate2" runat="server">
                                                                                        ...
                                                                                        <td align="center" valign="top">Criticidad</td>
                                                                                        <td align="left" valign="top">
                                                                                        <telerik:RadComboBox ID="cblcolor" runat="server" 
                                                                                                AutoPostBack="True" CausesValidation="False" DataTextField="description" 
                                                                                                DataValueField="value"  CheckBoxes="true" EnableCheckAllItemsCheckBox="true"
                                                                                                Skin="Default" Sort="Ascending" Width="180px" 
                                                                                                EmptyMessage="[-- Seleccione --]">
                                                    	    	...
                                                    	    	<table id="TblBuscar" runat="server" cellpadding="0" cellspacing="0" border="0" 
                                                    	    	    ...
                                                    	    	    <tr id="Tr5" runat="server">
                                                    	    	        <td id="Td6" valign="top" 
                                                                            ...
                                                                            runat="server">
                                                                            <asp:Panel ID="PnlZonaGraficoCriticidad" runat="server" ScrollBars="Auto" Height="650px" Width="900px"></asp:Panel>
...
<%--    <script type="text/javascript">
    ...
    <telerik:RadAjaxManagerProxy ID="RadAjaxManager1" runat="server">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="CmbseccionInfSemanal">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="CmbEqInfSemanal" 
                        LoadingPanelID="RadAjaxLoadingPanel1"  />
                </UpdatedControls>
            </telerik:AjaxSetting>
