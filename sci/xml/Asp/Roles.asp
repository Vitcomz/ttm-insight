...
function ListMenuRol()
	query = "SELECT COD_MENU, COD_ROL FROM MENUROL WHERE COD_ROL ='" & COD_ROL & "' "
	Set ORs =oDB.EjecutaSql(query)
	Response.Write "<?xml version='1.0' encoding='ISO-8859-15'?>" & VbCrLf & VbCrLf
	Response.Write "<REGISTROS>"
	While Not ORs.EOF 
	  Response.Write "<ROW>"
	  Response.Write "<COD_MENU>" & ORs.Fields.Item(0).Value & "</COD_MENU>"
	  Response.Write "<COD_ROL>" & ORs.Fields.Item(1).Value & "</COD_ROL>"
	  Response.Write "</ROW>"
	  ORs.MoveNext
	Wend
	Response.Write "</REGISTROS>"
