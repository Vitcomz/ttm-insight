...
var url;
	...
	url = "xml/Bodegas.asp?RECURSO=GetBodegaActual";
	var res = xmlTmp.load(url);
...
var script = "<div style='Z-INDEX: 10000;POSITION: absolute; TOP: 0px;LEFT: 2px;text-align:left;width:100%;'>";
	...
	script = script + "<TD align='left' class=txtTitle>SISTEMA DE VENTAS TTM CHILE  </TD><TD class=txtTitle> SUCURSAL : " + empresa + "</TD>";
...
var url;
url = "xml/Menu.asp?RECURSO=ListMenuxRol&SISTEMA=VENTAS";
url += "&ROL=" + rol;
