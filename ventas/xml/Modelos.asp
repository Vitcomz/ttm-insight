...
function NewModelo()
	...
	Dim N 
	query = "SELECT MAX(CODIGO) AS NUM FROM MODELOS "
	...
	query = "INSERT INTO MODELOS (CODIGO, DESCRIPCION, MARCA)"
	query = query & " VALUES ("
...
function ListModelos()
	...
	query = query & " FROM MODELOS "
	query = query & " WHERE MARCA=" & strNvl(MARCA)
...
function DelModelo()
	query = "DELETE FROM MODELOS WHERE CODIGO=" & CODIGO 
