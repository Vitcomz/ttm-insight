<%@ Page Title="" Language="C#" MasterPageFile="~/ttm_skins/ttm_template.Master" AutoEventWireup="true" CodeBehind="sci_roles.aspx.cs" Inherits="Insight.sci.sci_roles" 
                                                	...
                                                	<tr>
                                                    	<td style="width:900; height: 10px;" valign="top">
                                                        	<div class="ContTopLiBx">
                                                                            <div class="ContTitLiBx">Administrador Roles</div>
                                                                                ...
                                                                                <table cellpadding="0" cellspacing="0" border="0" style="width:700px">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td style="height: 24px" align="center" valign="top">Codigo
                                                                                            <br />
                                                                                            rol</td>
                                                                                        <td align="left" valign="top"><asp:TextBox ID="Txtidrolesfiltro" runat="server" SkinID="TextBoxBuscar"></asp:TextBox></td>
                                                                                        <td align="center" valign="top">Nombre
                                                                                            <br />
                                                                                            rol</td>
                                                                                        <td align="left" valign="top"><asp:TextBox ID="Txtrolesfiltro" runat="server" SkinID="TextBoxBuscar"></asp:TextBox></td>
                                                                                        <td align="center" valign="top">Estado
                                                                                            <br />
                                                                                            rol</td>
                                                                                        <td align="left" valign="top">
                                                                                            <asp:DropDownList ID="CblEstadorolesfiltro" runat="server" skinID="listamediano">
                                                    	        	        ...
                                                    	        	        <table cellpadding="0" cellspacing="0" border="0" style="width:900px">
                                                    	        	            <tr>    
                                                    	        	                <td style="width:300px; height: 20px;" valign="top" align="left">
                                                    	        	                    <asp:ImageButton runat="server" ID="IBtnNuevoRegistro" SkinID="IBtnNuevoGrid" OnClick="IBtnNuevoRegistro_Click" />&nbsp;&nbsp;<asp:LinkButton runat="server" ID="LBtnNuevoRegistro" Text="AGREGAR NUEVO ROL" SkinID="LBtnNuevoRegistro" OnClick="LBtnNuevoRegistro_Click" CausesValidation="False"></asp:LinkButton>
                                                    	        	                </td>
                                                                            ...
                                                                            <telerik:radgrid id="RadGrid1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" CellPadding="1" CellSpacing="1" GridLines="None" OnItemCommand="RadGrid1_ItemCommand" OnSortCommand="RadGrid1_SortCommand" OnPageIndexChanged="RadGrid1_PageIndexChanged" OnPageSizeChanged="RadGrid1_PageSizeChanged" OnSelectedIndexChanged="RadGrid1_SelectedIndexChanged">
                                                                                <MasterTableView CellPadding="1" CellSpacing="1" GridLines="Both" ShowFooter="True" DataKeyNames="id" PageSize="8">
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <telerik:GridBoundColumn DataField="nombre" HeaderText="roles" UniqueName="column3">
                                                                                            <HeaderStyle HorizontalAlign="Center" Width="45%" />
                                                                                            <ItemStyle HorizontalAlign="Center" />                                                                                        
                                                                                        </telerik:GridBoundColumn>
                                                        	            ...
                                                        	            <table cellpadding="0" cellspacing="0" border="0" width="900" class="FormularioMantenedores">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td valign="top" align="left" class="obligatorio" 
                                                                                    style="height: 24px; width: 115px;">Codigo rol</td>
                                                                                <td style="height: 24px">
                                                                                    </td>
                                                                                <td valign="top" align="left" style="height: 24px; width: 354px;">
                                                                                    <asp:TextBox ID="Txtcodigoroles" runat="server" SkinID="TextBoxCorto"></asp:TextBox>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Txtcodigoroles"
                                                                                        ErrorMessage="Codigo." Display="Dynamic">*</asp:RequiredFieldValidator>
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="Txtcodigoroles"
                                                                                        Display="Dynamic" ErrorMessage="Formato no valido solo caracteres en nombre roles"
                                                                                ...
                                                                                <td align="left" style="height: 24px; width: 354px;" valign="top">
                                                                                    <asp:TextBox ID="Txtnombreroles" runat="server" SkinID="TextBoxlargo"></asp:TextBox>
                                                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="Txtnombreroles"
                                                                                        ErrorMessage="Nombre." Display="Dynamic">*</asp:RequiredFieldValidator>
                                                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="Txtnombreroles"
                                                                                        Display="Dynamic" ErrorMessage="Formato no valido solo caracteres en nombre roles"
                                                                                        ValidationExpression=".*[0-9a-zA-Z-_@Á-Úá-ú-_@]+">*</asp:RegularExpressionValidator>
                                                                                </td>
